...
* **Consistency requirements**:
  * [We must talk consistently just as we must think consistently]{.smaller}
  * [We mustn't now call Abel 'Cain' or Cain 'Abel']{.smaller}

* **Systematic consequences**:
  * ["We ungear ourselves from the book of Genesis, and from all its connections with the universe of speech and fact"]{.smaller}
  * ["We throw ourselves out of whatever truth that whole system may embody"]{.smaller}
...
* [Twin Towers example: "We all know they were real... but how do we know it?"]{.smaller}
* ["We saw images, but the key point here is that we chose to trust"]{.smaller}

* **Verification delegation**:
* ["Different sources send different images showing the same event from different angles"]{.smaller}
* ["Strictly speaking, it's a delegation of verification. I do not verify anything"]{.smaller}
...
* **Empirical truths**: Require sense-verification, can change
  * ["If I am lost in the woods... it is of utmost importance that I should think of a human habitation"]{.smaller}
* [Objects: concrete things, dates, places, distances]{.smaller}
* **Logical/Mathematical truths**: "Eternal character" - once true, always true
  *[ "1 and 1 make 2... white differs less from gray than from black"]{.smaller}
  * [Objects: mental concepts, abstract relations]{.smaller}
...
* **Leading that pays**: Truth guides us toward valuable experiences
  * ["Any idea that helps us deal with either the reality or its belongings... will agree sufficiently"]{.smaller}
  * ["Leading that is useful because it is into quarters that contain objects that are important"]{.smaller}
...
* **Historical examples**:
  * ["Ptolemaic astronomy, Euclidean space, Aristotelian logic... were expedient for centuries"]{.smaller}
  * [Now "only relatively true, or true within those borders of experience"]{.smaller}
...
* **Objective constraints on pragmatists**:
  * ["Pent in... between the whole body of funded truths squeezed from the past"]{.smaller}
  * ["And the coercions of the world of sense about him"]{.smaller}
  * ["Who so well as he feels the immense pressure of objective control?"]{.smaller}
